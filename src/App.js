...
import { useEffect } from 'react';
 import Loader from './component/Mainloader'
  ...
  <nav className="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
    <div className="container">
      ...
      <a className="navbar-brand logo" href="/">
        <img src={logo} alt='photo' className height={21} />
      </a>
      ...
      <div className="collapse navbar-collapse" id="navbarCollapse">
        <ul className="navbar-nav ml-auto navbar-center" id="mySidenav">
          ...
          <Link  className="nav-link pointer"  activeClass="active" to="services" spy={true} smooth={true} offset={-70} duration={1000}>
            Services
            </Link>
          </li>
          <li className="nav-item">
          <Link  className="nav-link pointer"  activeClass="active" to="about" spy={true} smooth={true} offset={-70} duration={1000}>
          About
            </Link>
          </li>
          <li className="nav-item">
          <Link  className="nav-link pointer"  activeClass="active" to="features" spy={true} smooth={true} offset={-70} duration={1000}>
          Features
            </Link>
            
          </li>
          <li className="nav-item">
          <Link  className="nav-link pointer"  activeClass="active" to="clients" spy={true} smooth={true} offset={-70} duration={1000}>
          Clients
            </Link>
        ...
        <div className="call-no">
          <a href="#" className="nav-link pointer text-warning"><i className="mdi mdi-phone mr-1" /> +00 1234 5678 90</a>
        </div>
      </div>
    </div>
  </nav>
      ...
      <div className="row" id="counter">
        <div className="col-lg-3 col-md-6">
          <div className="counter-box text-center text-white mb-4 mb-lg-0">
            ...
            <h2 className="mb-2 font-weight-normal"><span className="counter-value mt-4" data-count={620}>0</span>+</h2>
        ...
        <div className="col-lg-3 col-md-6">
          <div className="counter-box text-center text-white mb-4 mb-lg-0">
            ...
            <h2 className="mb-2 font-weight-normal"><span className="counter-value mt-4" data-count={350}>0</span>+</h2>
        ...
        <div className="col-lg-3 col-md-6">
          <div className="counter-box text-center text-white mb-4 mb-lg-0">
            ...
            <h2 className="mb-2 font-weight-normal"><span className="counter-value mt-4" data-count={800}>0</span>+</h2>
        ...
        <div className="col-lg-3 col-md-6">
          <div className="counter-box text-center text-white mb-4 mb-lg-0">
            ...
            <h2 className="mb-2 font-weight-normal"><span className="counter-value mt-4" data-count={590}>0</span></h2>
  ...
  <section className="footer  bg-light">
    <div className="container">
      <div className="row">
        <div className="col-lg-4">
          <div className="mb-4">
            <a href="layout-one-1.html"><img src="images/logo-dark.png" alt='photo' className="logo-dark" height={26} /></a>
